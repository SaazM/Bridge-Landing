...
export default function BeyondResumesEmployer() {
    ...
    <div ref={sectionRef} className="relative py-16 md:py-20 px-4 md:px-6 bg-white border-t border-gray-200">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          <p className="text-base md:text-xl text-[#6B7280] max-w-2xl mx-auto leading-relaxed font-normal">Stop filtering candidates by keywords. Bridge analyzes code, understands projects, and turns them into a dynamic map of skills and growth to identify top talent you'd otherwise miss.
