...
const steps = [
  {
    ...
    description: "Connect your LinkedIn, GitHub, or upload your resume. Takes less than 3 minutes."
  },
  {
    number: "02",
    icon: Brain,
    title: "AI matches you weekly",
    description: "Our algorithm analyzes your skills, interests, and goals to find perfect startup fits."
  },
  {
    number: "03",
    icon: Handshake,
    title: "Interview directly",
    description: "Skip applications. Book interviews or start assesments with one click. No cover letters, no ghosting."
  }
];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className="text-5xl lg:text-6xl font-semibold mb-6 tracking-tight">
            <span className="text-[#0B1121]">Three steps to your</span>{" "}
            <span className="text-[#1E3A8A]">dream internship</span>
          </h2>
          <p className="text-xl text-[#6B7280] max-w-2xl mx-auto leading-relaxed font-normal">
            Instead of searching for internships, we search for you — comparing your skills to every opening on the platform and guaranteeing you an interview or assessment each week.
          </p>
        </motion.div>
